...
if (isset($_POST["submit"]) && $_POST["submit"] == "Submit") {
    echo "<button type=\"submit\" onclick=\"startAgain();\">Start Over</button> \n";
        ...
        <div class="column-left">
            <fieldset>
                ...
                <table border="1" class="column">
                    ...
                    <tr>
                        <td class="colleft">
                            <label for="cc_Email"><strong>CC Recipients</strong> 
                    ...
                    <tr>
                        <td class="colleft">
                            <label for="bcc_Email"><strong>BCC Recipients</strong> 
                                <small>(separate with commas)</small>
                            </label>
                        </td>
                        <td class="colrite">
                    ...
                    <tr>
                        <td class="colleft">
                            <label for="Message"><strong>Message</strong> 
